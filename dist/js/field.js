...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-nova-json-field', __webpack_require__(3));
    Vue.component('detail-nova-json-field', __webpack_require__(6));
    Vue.component('form-nova-json-field', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        returnValue: function returnValue(key) {
        ...
        fieldProperty: function fieldProperty(property) {
        ...
        gofetch: function gofetch() {
            ...
            var fieldElement = '';
            var inputValueOnForm = null;
            var valueInPayload = null;
            var modifiedURL = this.field.url;
            ...
            this.field.inputFields.forEach(function (inputField) {
                ...
                modifiedURL = _this.field.url.replace('$' + inputField.fetchkeyname, inputValueOnForm);
                console.log('Modified URL is ', modifiedURL);
            });

            axios.get(modifiedURL).then(function (res) {
                _this.fetching = false;
                console.log('We have data:', res.data);
                _this.value = res.data;
                //fieldElement = document.getElementById('client_surname');
                _this.hasdata = true;
                console.log('Output fields:', _this.field.outputFields);

                _this.field.outputFields.forEach(function (outputField) {
                    console.log('Lets try to find output field ', outputField.formid);
                    fieldElement = document.getElementById(outputField.formid);
                    console.log('Element is ', fieldElement);
                    valueInPayload = _this.returnValue(outputField.jsonkey);
      ...
      _c("template", { slot: "field" }, [
        _c("input", {
          ...
          attrs: {
            ...
            url: _vm.field.url,
            method: _vm.field.method,
            buttonLabel: _vm.field.buttonLabel,
            outputFields: _vm.field.outputFields,
            save: _vm.field.save,
            inputFields: _vm.field.inputFields
          },
        ...
        _c(
          "button",
          {
            ...
            attrs: { for: "field.name", type: "button" },
            on: {
          ...
          [_c("span", [_vm._v(_vm._s(_vm.field.buttonLabel))])]
        ),
        _vm._v(" "),
        _vm.hasdata
          ? _c("div", [
              _c("p", [_vm._v("Title: " + _vm._s(_vm.returnValue("title")))]),
              _vm._v(" "),
              _c("p", [_vm._v("Id: " + _vm._s(_vm.returnValue("id")))])
            ])
          : _vm._e(),
        _vm._v(" "),
        _vm.fetching
          ? _c(
              ...
              [
                _c("circle", { attrs: { cx: "15", cy: "15", r: "11.7475" } }, [
                  _c("animate", {
                    attrs: {
                      attributeName: "r",
                      from: "15",
                ...
                _c("circle", { attrs: { cx: "105", cy: "15", r: "11.7475" } }, [
                  _c("animate", {
                    attrs: {
                      attributeName: "r",
                      from: "15",
